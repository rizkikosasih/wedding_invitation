...
-- Dumping data for table wedding_ola.bank: 3 rows
DELETE FROM `bank`;
...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `event_name` varchar(250) NOT NULL DEFAULT '0',
...
INSERT INTO `event` (`id`, `bank_id`, `event_name`, `reception_date`, `wedding_date`, `reception_location`, `wedding_location`, `number_rekening`, `atas_nama`, `wedding_map`, `cover`, `background_gallery`, `background_home`, `name_man`, `alias_man`, `desc_man`, `image_man`, `name_woman`, `alias_woman`, `desc_woman`, `image_woman`, `date_added`, `date_modify`) VALUES
	(1, 1, 'Wedding Ola & Atta', '2023-02-05 10:30:00', '2023-02-05 09:00:00', 'Jl. Sabangan No. 378', 'Jl. Sabangan No. 378', '1234567890', 'Ariola', '&lt;iframe src=&quot;https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.769504343384!2d106.81222731435987!3d-6.1616166621031905!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f67683b657bd%3A0xb9b974541a653ffd!2sJl.%20Petojo%20Utara%20III%20No.240%2C%20RT.17%2FRW.3%2C%20Petojo%20Utara%2C%20Kecamatan%20Gambir%2C%20Kota%20Jakarta%20Pusat%2C%20Daerah%20Khusus%20Ibukota%20Jakarta%2010130!5e0!3m2!1sen!2sid!4v1671244826772!5m2!1sen!2sid&quot; width=&quot;1920&quot; height=&quot;1080&quot; style=&quot;border:0;&quot; allowfullscreen=&quot;true&quot; loading=&quot;lazy&quot; referrerpolicy=&quot;no-referrer-when-downgrade&quot;&gt;&lt;/iframe&gt;', '', '60122_gallery.jpg', '79728_carousel-1.jpg', 'Janahtan Firdaus', 'Janahtan', '&lt;p&gt;&lt;span style=&quot;color: #818491; font-family: Montserrat, sans-serif; font-size: 16px; text-align: right; background-color: #edf5f7;&quot;&gt;Lorem elitr magna stet rebum dolores sed. Est stet labore est lorem lorem at amet sea, eos tempor rebum, labore amet ipsum sea lorem, stet rebum eirmod amet. Kasd clita kasd stet amet est dolor elitr.&lt;/span&gt;&lt;/p&gt;', '83918_about-1.jpg', 'Riska Ariola', 'Ariola', '&lt;p&gt;&lt;span style=&quot;color: #818491; font-family: Montserrat, sans-serif; font-size: 16px; text-align: right; background-color: #edf5f7;&quot;&gt;Lorem elitr magna stet rebum dolores sed. Est stet labore est lorem lorem at amet sea, eos tempor rebum, labore amet ipsum sea lorem, stet rebum eirmod amet. Kasd clita kasd stet amet est dolor elitr.&lt;/span&gt;&lt;/p&gt;', '83918_about-11.jpg', '2022-12-17 12:36:26', '2022-12-17 05:36:26');
...
-- Dumping data for table wedding_ola.gallery: 6 rows
DELETE FROM `gallery`;
...
INSERT INTO `gallery` (`id`, `event_id`, `images`, `description`, `date_added`, `date_modify`, `isActive`, `isDelete`) VALUES
	...
	(5, 1, '98443_gallery-5.jpg', 'Gambar 5', '2022-12-18 23:59:56', '2022-12-18 16:59:56', 1, 0),
	(6, 1, '16564_gallery-6.jpg', 'Gambar 6', '2022-12-19 00:00:14', '2022-12-18 17:00:14', 1, 0);
...
-- Dumping data for table wedding_ola.grup: 5 rows
DELETE FROM `grup`;
...
-- Dumping data for table wedding_ola.halaman_statis: 13 rows
...
-- Dumping data for table wedding_ola.love_story: 4 rows
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `urutan` int(11) NOT NULL DEFAULT 2,
...
-- Dumping data for table wedding_ola.pelanggan: 519 rows
...
-- Dumping data for table wedding_ola.reservation: 0 rows
...
-- Dumping data for table wedding_ola.role_event: 1 rows
...
-- Dumping data for table wedding_ola.statis_template: 0 rows
